...
def ScalarMultiplicationInOdd235(vect,coor,p):
...
#	t0=time.time()
#	Z=ScalarMultiplicationInOdd235(vect,coor,p)
#	t1=time.time()
...
#t := [1,0,0,0,0,0,0];
#d := [14,10,8,7,7,4,1];
#a := 2^8 * 3^1 * 5^14 - 2^8 * 3^0 * 5^10 - 2^8 * 3^0 * 5^8 - 2^7 * 3^0 * 5^7 - 2^3 * 3^0 * 5^7 + 2^1 * 3^0 * 5^4 - 2^1 * 3^0 * 5^1;
#
#Z := s[1]*P;
#//t:=s[1];
#aux:=0;
