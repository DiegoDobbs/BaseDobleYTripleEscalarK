...
def ScalarMultiplicationInOdd257(vect,coor,p):
...
#	t0=time.time()
#	Z=ScalarMultiplicationInOdd257(vect,coor,p)
#	t1=time.time()
...
#t := [3, 3, 1, 1, 0, 0, 0, 0] ;
#d := [4, 2, 2, 1, 1, 1, 0, 0] ;
#a := 2^3 * 5^3 * 7^4 - 2^0 * 5^3 * 7^2 - 2^0 * 5^1 * 7^2 - 2^0 * 5^1 * 7^1 + 2^0 * 5^0 * 7^1 + 2^0 * 5^0 * 7^1 - 2^0 * 5^0 * 7^0 - 2^0 * 5^0 * 7^0;
#
#Z := s[1]*P;
#aux:=0;
#for x in s do 
